...
export const learningPaths: LearningPath[] = [
  {
    id: "1",
    slug: "ai-creative-specialist",
    title: "AI Creative Specialist",
    tagline: "Launch Your Career as an AI-Powered Creative Professional",
    description: "Master the tools and workflows to become a sought-after creative professional who leverages AI for content creation, design, video production, and brand storytelling. This career path prepares you for roles like AI Creative Specialist, Content Creator, Digital Designer, or Creative Technologist.",
    duration: "12 weeks",
  ...
  },
  {
    ...
    tagline: "Build Your Career in AI-Driven Marketing & Analytics",
    description: "Position yourself for high-demand marketing roles by mastering AI-powered analytics, automation, and campaign optimization. This career path prepares you for positions like Marketing Analyst, Growth Marketer, Marketing Automation Specialist, or Digital Strategy Consultant using cutting-edge AI tools.",
    duration: "10 weeks",
    level: "Beginner to Intermediate",
    nextIntake: "May 2026",
    price: "KES 65,000",
  ...
  },
  {
    ...
    tagline: "Launch Your Career in AI-Powered Business Intelligence",
    description: "Become a strategic business professional who uses AI for data analysis, forecasting, and decision-making. This career path prepares you for roles like Business Analyst, Data Analyst, BI Specialist, Operations Analyst, or Strategic Insights Manager in modern data-driven organizations.",
    duration: "12 weeks",
    level: "Intermediate",
