...
export const learningPaths: LearningPath[] = [
  {
    ...
    tagline: "Create More, Stress Less with AI Tools",
    description: "Turn creative ideas into polished content in minutes. AI can help you write compelling scripts, edit videos faster, design visuals, and analyze audience performance — freeing you to focus on storytelling and originality. Explore how creators are using AI to boost productivity, scale their brands, and earn more while doing what they love.",
    duration: "12 weeks",
  ...
  },
  {
    ...
    description: "The modern workplace runs on intelligence. From automating routine marketing tasks and managing campaign data to enhancing collaboration and creativity, AI tools are making marketing work faster and more meaningful. Discover practical ways to integrate AI into your marketing workflow and unlock new levels of efficiency, innovation, and results.",
    duration: "10 weeks",
    level: "Beginner to Intermediate",
    nextIntake: "May 2026",
    price: "KES 65,000",
  ...
  },
  {
    ...
    tagline: "Drive Growth with AI-Powered Decisions",
    description: "Businesses that embrace AI move faster, serve customers better, and scale sustainably. From predictive analytics and customer engagement automation to intelligent insights and data-driven strategies — learn how to harness AI to boost performance, make informed decisions, and stay ahead in competitive markets.",
    duration: "12 weeks",
    level: "Intermediate",
